...
const definitionName = 'Spiral.gh'

// Set up sliders
const radius_slider = document.getElementById('sections')
...
async function compute() {
    ...
    const param1 = new RhinoCompute.Grasshopper.DataTree('sections')
    param1.append([0], [radius_slider.valueAsNumber])

    const param2 = new RhinoCompute.Grasshopper.DataTree('rotation')
